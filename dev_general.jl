...
model = yaml_import("examples/ymodels/rbc_mc.yaml")
...
model = yaml_import("examples/ymodels/consumption_savings.yaml")
...
model2 = include("examples/ymodels/consumption_savings.jl")
